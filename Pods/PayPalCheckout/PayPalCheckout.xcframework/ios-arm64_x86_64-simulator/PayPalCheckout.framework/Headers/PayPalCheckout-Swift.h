...
@property (nonatomic, readonly, copy) NSString * _Nullable fullName;
/// Portable address fields
@property (nonatomic, readonly, copy) NSString * _Nullable adminArea1;
@property (nonatomic, readonly, copy) NSString * _Nullable adminArea2;
@property (nonatomic, readonly, copy) NSString * _Nullable adminArea3;
@property (nonatomic, readonly, copy) NSString * _Nullable adminArea4;
@property (nonatomic, readonly, copy) NSString * _Nullable postalCode;
@property (nonatomic, readonly, copy) NSString * _Nullable countryCode;
/// Coarse address fields
@property (nonatomic, readonly, copy) NSString * _Nullable city SWIFT_DEPRECATED_MSG("Use adminArea instead");
@property (nonatomic, readonly, copy) NSString * _Nullable state SWIFT_DEPRECATED_MSG("Use adminArea instead");
@property (nonatomic, readonly, copy) NSString * _Nullable country SWIFT_DEPRECATED_MSG("Use countryCode instead");
- (nonnull instancetype)initWithAddressID:(NSString * _Nullable)addressID fullName:(NSString * _Nullable)fullName adminArea1:(NSString * _Nullable)adminArea1 adminArea2:(NSString * _Nullable)adminArea2 adminArea3:(NSString * _Nullable)adminArea3 adminArea4:(NSString * _Nullable)adminArea4 postalCode:(NSString * _Nullable)postalCode countryCode:(NSString * _Nullable)countryCode OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
