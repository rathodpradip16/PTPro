...
class ManageAccVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let regularText = NSAttributedString(string: String(format:"\(Utility.shared.getLanguage()?.value(forKey:"deleteCaution") ?? "All of your data and current reservations and bookings will be lost if you delete your %@ account.")",appName), attributes: regularAttribute)
