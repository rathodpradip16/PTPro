...
class FeebackHeaderCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        descLabel.text = String(format:"\(Utility.shared.getLanguage()?.value(forKey:"feedDesc") ?? "We're always working to improve the %@ experience, so we'd love to hear what's working and how we can do better.")",appName)
