...
public class GetBillingCalculationQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct GetBillingCalculation: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.AllBillingType }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct Result: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.BillingType }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
        ...
        public struct SpecialPricing: PTProAPI.SelectionSet {
          ...
          public static var __parentType: Apollo.ParentType { PTProAPI.Objects.SpecialPricingType }
          public static var __selections: [Apollo.Selection] { [
            .field("__typename", String.self),
