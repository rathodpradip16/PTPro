...
public class GetPropertyManagersDataQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct GetPropertyManagersData: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.GetClicks }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct GraphData: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.GetData }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
        ...
        public struct Data1: PTProAPI.SelectionSet {
          ...
          public static var __parentType: Apollo.ParentType { PTProAPI.Objects.GetGraph }
          public static var __selections: [Apollo.Selection] { [
            .field("__typename", String.self),
