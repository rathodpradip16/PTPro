...
public class GetDefaultSettingQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct Currency: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.Currency }
      public static var __selections: [Apollo.Selection] { [
        .field("__typename", String.self),
      ...
      public struct Result: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.AllRatesType }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
    ...
    public struct GetSearchSettings: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.AllSearchSettingsType }
      public static var __selections: [Apollo.Selection] { [
        .field("__typename", String.self),
      ...
      public struct Results: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.SearchSettingsType }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
          .field("id", Int?.self),
    ...
    public struct GetListingSettingsCommon: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.ListingSettingCommonTypes }
      public static var __selections: [Apollo.Selection] { [
        .field("__typename", String.self),
        .field("status", Int?.self),
        .field("errorMessage", String?.self),
      ...
      public struct Result: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.ListingSettingsTypesCommon }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
          .field("id", Int?.self),
        ...
        public struct ListSetting: PTProAPI.SelectionSet {
          ...
          public static var __parentType: Apollo.ParentType { PTProAPI.Objects.ListingSettingsCommon }
          public static var __selections: [Apollo.Selection] { [
            .field("__typename", String.self),
            .field("id", Int?.self),
            .field("image", String?.self),
    ...
    public struct SiteSettings: PTProAPI.SelectionSet {
      ...
      public struct Result: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.SiteSettings }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
          .field("id", Int?.self),
          .field("title", String?.self),
