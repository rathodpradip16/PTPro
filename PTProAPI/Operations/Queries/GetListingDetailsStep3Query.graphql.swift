...
extension PTProAPI {
  class GetListingDetailsStep3Query: GraphQLQuery {
    ...
    static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"query GetListingDetailsStep3($listId: String!, $preview: Boolean) { getListingDetails(listId: $listId, preview: $preview) { __typename results { __typename id userId bookingType isPublished houseRules { __typename isAgeSelected isEventSelected isPetSelected isChildrenSelected isSmokingSelected age { __typename age } event { __typename isBirthDay isFamilyGathering isOtherSelcted otherDetails attendees } pet { __typename petNo isDogAllowed isCatAllowed anypet petSize } children { __typename twoyears twelveyears seventeenyears } smoking { __typename indoors outDoors details } dynamicRules { __typename rule id isSelected isNoSelected Details } } listingData { __typename bookingNoticeTime checkInStart checkInEnd maxDaysNotice earlyCheckInFees minNight maxNight basePrice cleaningPrice currency is_affiliate affiliate_commission weeklyDiscount monthlyDiscount cancellationPolicy petFee petSelected checkInEntrySelected checkInType texTypeId taxPercentage taxPersonAge taxAmount aboutHost { __typename isProfessional bdStreet bdApt bdCity bdState bdzipcode bdCountry bmFirstname bmLastname businessName } } blockedDates { __typename blockedDates reservationId } calendars { __typename id name url listId status } } status errorMessage } }"#
      ))
    ...
    struct Data: PTProAPI.SelectionSet {
      ...
      struct GetListingDetails: PTProAPI.SelectionSet {
        ...
        struct Results: PTProAPI.SelectionSet {
          ...
          /// GetListingDetails.Results.HouseRules
          ///
          ...
          struct HouseRules: PTProAPI.SelectionSet {
            ...
            /// GetListingDetails.Results.HouseRules.Age
            ///
            /// Parent Type: `Ageypes`
            ...
            /// GetListingDetails.Results.HouseRules.Event
            ///
            /// Parent Type: `Events`
            ...
            /// GetListingDetails.Results.HouseRules.Pet
            ///
            /// Parent Type: `Pets`
            ...
            /// GetListingDetails.Results.HouseRules.Children
            ///
            ...
            /// GetListingDetails.Results.HouseRules.Smoking
            ///
            ...
            /// GetListingDetails.Results.HouseRules.DynamicRule
            ///
          ...
          struct ListingData: PTProAPI.SelectionSet {
            ...
            /// GetListingDetails.Results.ListingData.AboutHost
            ///
