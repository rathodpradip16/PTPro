...
public class ShowUserProfileQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct ShowUserProfile: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.ShowUserProfileCommon }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct Results: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.ShowUserProfile }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
