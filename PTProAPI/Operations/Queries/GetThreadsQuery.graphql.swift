...
public class GetThreadsQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct GetThreads: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.NewThreadsCommonType }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct Results: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.NewThreadsType }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
