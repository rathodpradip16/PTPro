...
public class GetDashboardDataQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct GetDashboardData: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.GetClicksType }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct GraphDatum: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.GetGraphType }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
