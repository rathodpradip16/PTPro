...
extension PTProAPI {
  class ReservationStatusMutation: GraphQLMutation {
    static let operationName: String = "ReservationStatus"
    ...
    struct Data: PTProAPI.SelectionSet {
      ...
      var reservationStatus: ReservationStatus? { __data["ReservationStatus"] }

      /// ReservationStatus
      ///
      /// Parent Type: `SendMessage`
      struct ReservationStatus: PTProAPI.SelectionSet {
        let __data: DataDict
        init(_dataDict: DataDict) { __data = _dataDict }
