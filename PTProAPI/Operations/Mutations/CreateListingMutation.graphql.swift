...
public class CreateListingMutation: GraphQLMutation {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct CreateListing: PTProAPI.SelectionSet {
      ...
      public static var __parentType: Apollo.ParentType { PTProAPI.Objects.ListingResponse }
      public static var __selections: [Apollo.Selection] { [
      ...
      public struct Results: PTProAPI.SelectionSet {
        ...
        public static var __parentType: Apollo.ParentType { PTProAPI.Objects.CreateListing }
        public static var __selections: [Apollo.Selection] { [
          .field("__typename", String.self),
