...
public class ManageListingsQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct ManageListings: PTProAPI.SelectionSet {
      ...
      public static var __parentType: ApolloAPI.ParentType { PTProAPI.Objects.WholeManageListingsType }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      public struct Result: PTProAPI.SelectionSet {
        ...
        public struct ListingSteps: PTProAPI.SelectionSet {
          ...
          public static var __parentType: ApolloAPI.ParentType { PTProAPI.Objects.UserListingSteps }
          public static var __selections: [ApolloAPI.Selection] { [
            .field("__typename", String.self),
            .field("id", Int?.self),
