...
public class ManageListingsQuery: GraphQLQuery {
  ...
  public struct Data: PTProAPI.SelectionSet {
    ...
    public struct ManageListings: PTProAPI.SelectionSet {
      ...
      public static var __parentType: ParentType { PTProAPI.Objects.WholeManageListingsType }
      public static var __selections: [Selection] { [
      ...
      public struct Result: PTProAPI.SelectionSet {
        ...
        public struct ListingSteps: PTProAPI.SelectionSet {
          ...
          public static var __parentType: ParentType { PTProAPI.Objects.UserListingSteps }
          public static var __selections: [Selection] { [
            .field("id", Int?.self),
